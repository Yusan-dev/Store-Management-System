...
function applyCustomCertColor(printArea, hexColor) {
    ...
    printArea.style.background = `linear-gradient(135deg, #fefce8 0%, ${bgTint} 100%), url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.06'/%3E%3C/svg%3E")`;
    printArea.style.backgroundBlendMode = 'multiply';
    ...
    function updateCertificatePreview() {
        ...
        if (printArea) {
            if (frameColor === 'custom') {
                ...
                printArea.style.background = '';
                printArea.style.backgroundBlendMode = '';
